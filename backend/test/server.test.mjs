...
// (CI intentionally sets DATABASE_URL === TEST_DATABASE_URL to the same disposable local DB, so we only
// check that the URL itself looks like a local/test database, not whether the two vars are equal.)
